...
public class UsbEventWatcher : IUsbEventWatcher
{
    ...
    private void StartWindowsWatcher(bool usePnPEntity = false)
    {
        ...
        _volumeChangeEventWatcher.EventArrived += VolumeChangeEventWatcher_EventArrived;
        ...
        if (usePnPEntity)
        {
            _instanceCreationEventWatcher.EventArrived += PnPEntityCreationEventWatcher_EventArrived;
            _instanceDeletionEventWatcher.EventArrived += PnPEntityDeletionEventWatcher_EventArrived;
        ...
        {
            _instanceCreationEventWatcher.EventArrived += USBControllerDeviceCreationEventWatcher_EventArrived;
            _instanceDeletionEventWatcher.EventArrived += USBControllerDeviceDeletionEventWatcher_EventArrived;
